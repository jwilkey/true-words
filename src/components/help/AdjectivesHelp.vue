<template>
  <div class="container">
    ...
    <hr />
    <div>
       In the same way as you selected each adjective, optionally select the target of each adjective (who or what the word is describing). Press <span class="btn callout-light help-action">DONE</span> when you are finished selecting targets, or to skip this step.
    </div>
  </div>
</template>
